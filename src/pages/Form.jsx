...
const MyForm = ({ datas, navigate }) => {
  ...
  return (
    <>
      <FormProvider {...methods}>
        ...
        /> */}
          ...
          <div className="flex justify-between items-center gap-4">
            ...
            <button
              disabled={loading}
              className="bg-[#00bbab] cursor-pointer hover:bg-[#51ada5f3] w-full font-semibold text-white py-3 px-4 rounded mt-4"
            >
              {loading ? (
                <Loader />
              ) : existingCourse ? (
      ...
      {loading ? (
        <div
          className="fixed inset-0 text-black flex justify-center items-center z-50
      glass-premium  p-6 rounded-2xl shadow-2xl border border-white/20 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl
      h-screen"
        >
          <Loader />
        </div>
