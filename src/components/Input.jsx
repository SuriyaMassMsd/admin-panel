...
const Input = ({
  ...
  const baseInputClasses =
    "px-[10px] w-full mt-2 py-[10px] border rounded bg-[#f7f7f7] placeholder:text-gray-600 placeholder:font-[500] text-[#333] outline-none";
  const errorClasses =
              ...
              onChange={(e) => {
                ...
                if (file.type.startsWith("video/")) {
                  ...
                  video.onloadedmetadata = () => {
                    ...
                    // ✅ Set both file and duration as an object
                    setValue(
                      name,
                      { file, duration },
                      { shouldValidate: true }
                  ...
                  // If it's an image or other file, just set the file
