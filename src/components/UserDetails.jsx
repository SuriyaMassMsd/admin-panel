...
const { role } = getUserValue() || [];

const BootstrapDialog = styled(Dialog)(({ theme }) => ({
  "& .MuiDialog-paper": {
    width: role === "Admin" ? "900px" : "700px",
    maxWidth: "90%",
  },
    ...
    <div>
      ...
      >
        ...
        <DialogContent dividers>
          <div
            className={`flex  space-x-[60px] px-10  py-6 gap-5 ${role === "Admin" ? "justify-start items-start" : "justify-center items-center"}`}
          >
